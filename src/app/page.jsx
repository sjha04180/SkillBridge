...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-950 text-slate-100 overflow-hidden">
      ...
      <section className="relative pt-20 pb-16 md:pt-32 md:pb-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-400 md:text-xl font-medium">
            SkillBridge connects college students to share skills, collaborate
            on technical projects, and help peers master new tools in real time.
          </p>
              ...
              <>
                ...
                <Link href="/dashboard/profile">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full sm:w-auto text-slate-300 border-border/40 font-semibold cursor-pointer"
                  >
                    View My Profile
                  </Button>
                </Link>
      ...
      <section
        id="features"
        className="py-16 md:py-24 border-t border-border/10 bg-slate-950/40 relative"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
          <div className="text-center space-y-4">
            ...
            <p className="mx-auto max-w-2xl text-slate-400 font-medium">
              Empower your college community with features built to highlight
              student competencies and foster peer tutoring.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group rounded-2xl border border-border/10 bg-slate-950/20 p-8 hover:bg-slate-900/30 hover:border-violet-500/20 transition-all duration-300 backdrop-blur-md">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Filter students by precise technical disciplines, frameworks, or
                languages to find the exact peer you need.
              </p>
            </div>
            ...
            <div className="group rounded-2xl border border-border/10 bg-slate-950/20 p-8 hover:bg-slate-900/30 hover:border-indigo-500/20 transition-all duration-300 backdrop-blur-md">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Interact exclusively with students from your college or across
                trusted academic systems for collaboration.
              </p>
            </div>
            ...
            <div className="group rounded-2xl border border-border/10 bg-slate-950/20 p-8 hover:bg-slate-900/30 hover:border-blue-500/20 transition-all duration-300 backdrop-blur-md">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Build study groups, initiate chat connections, and launch
                hackathon teams based on complementary skills.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-slate-400 leading-relaxed font-medium">
                Traditional education teaches theories, but real growth happens
                through collaboration. SkillBridge was built by engineers who
                saw a disconnect between college branches.
              </p>
              <p className="text-slate-400 leading-relaxed font-medium">
                By enabling students from computer science, electronics,
                business, and arts to index their capabilities, SkillBridge acts
                as a secure campus directory for skill trading, homework help,
                and hackathon matches.
              </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400">
                        TCET Mumbai • Computer Engineering
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl border border-border/10 bg-slate-950/60 p-8 md:p-12 overflow-hidden shadow-2xl backdrop-blur-md text-center space-y-6">
            ...
            <p className="mx-auto max-w-xl text-slate-400 font-medium">
              Create your SkillBridge account in seconds, highlight your
              competencies, and search for potential project collaborators.
            </p>
            <div className="pt-2">
