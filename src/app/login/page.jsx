      ...
      <Card className="w-full max-w-md border border-border/10 bg-slate-950/40 shadow-2xl backdrop-blur-md">
        ...
        <CardContent>
          ...
          <div className="relative flex items-center justify-center my-5">
            <span className="absolute px-3 text-[10px] uppercase font-bold text-slate-500 bg-slate-950">
              Or continue with
            </span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              ...
              className="bg-slate-900 hover:bg-slate-800 border border-white/5 font-semibold text-xs flex items-center justify-center gap-2 cursor-pointer h-10 rounded-xl text-slate-200"
            >
              <svg
